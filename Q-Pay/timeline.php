...
<body class="fixed-nav sticky-footer bg-dark" id="page-top">      
  ...
  <nav class="navbar navbar-expand-lg navbar-dark bg-dark fixed-top" id="mainNav">
    <a class="navbar-brand" href="index.php?page=dashboard">Quick Payment</a>
    ...
    <div class="collapse navbar-collapse" id="navbarResponsive">
      <ul class="navbar-nav navbar-sidenav" id="exampleAccordion">
        ...
        <li class="nav-item" data-toggle="tooltip" data-placement="right" title="Master Pages">
...
-->
        ...
        <li class="nav-item" data-toggle="tooltip" data-placement="right" title="Tables">
          <a class="nav-link" href="timeline.php?page=pengguna">
            <i class="fa fa-fw fa-image"></i>
            <span class="nav-link-text">Ganti Poto</span>
          </a>
        </li>
        <li class="nav-item" data-toggle="tooltip" data-placement="right" title="Tables">
          <a class="nav-link" href="timeline.php?page=pengguna">
      ...
      <!--
        <li class="nav-item dropdown">
          <a class="nav-link dropdown-toggle mr-lg-5" id="messagesDropdown" href="#" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
          ...
          <?php 
              ...
              if(isset($_GET['page'])){
                ...
                switch ($page) {
                  ...
                  break;
                  case 'pemasok':
                    include "halaman/read_pemasok.php";
                  break;
                  case 'karyawan':
